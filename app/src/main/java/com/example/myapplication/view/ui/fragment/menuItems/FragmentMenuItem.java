package com.example.myapplication.view.ui.fragment.menuItems;
...
import com.example.myapplication.view.ui.fragment.decoration.SpacesItemDecoration;
...
public class FragmentMenuItem extends Fragment {
    ...
    private List<MusicGenreData> getData() {
        ...
        result.add(new MusicGenreData("Кантри", "", ""));
        result.add(new MusicGenreData("Джаз", "", ""));
        result.add(new MusicGenreData("Хип-хоп", "", ""));
        return result;
    }
